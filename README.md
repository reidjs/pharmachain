...
Features
Intuitive UI using Material UI and Drag-Drop File Upload

Smart Contracts on the Ethereum Blockchain Ledger for Contract Management.

Recursive Neural Network to Predict Future Inventory.

Implementation details
Intuitive UI and Design
Smart Contracts on the Ethereum Blockchain Ledger for Contract Management between Manufacturer and Hospital.
Recursive Neural Network to Predict Future Inventory Requirements.
